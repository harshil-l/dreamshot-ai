    ...
    return (
        <div className="relative h-10 sm:h-12 md:h-14 bg-gray-100 rounded-lg p-0.5 sm:p-1 flex items-center w-full max-w-xs sm:max-w-sm md:max-w-md mx-auto">
            ...
            <button
                ...
                className={`relative z-10 flex-1 h-full px-3 py-1.5 sm:px-4 sm:py-2 md:px-6 md:py-2.5 text-xs sm:text-sm md:text-base font-medium transition-colors duration-200  hover:opacity-80 ${billingPeriod === 'monthly'
                    ? 'text-white'
                    : 'text-gray-500'
                    }`}
            >
            ...
            <button
                ...
                className={`relative z-10 flex-1 h-full px-3 py-1.5 sm:px-4 sm:py-2 md:px-6 md:py-2.5 text-xs sm:text-sm md:text-base font-medium transition-colors duration-200 hover:opacity-80 flex items-center justify-center ${billingPeriod === 'annually'
                    ? 'text-white'
                    : 'text-black'
                    }`}
            >
